...
namespace SystemeNote.Controllers
{
    ...
    public class NoteEtudiantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EtudiantId,ParcoursEtudiantId,Note,PromotionId")] NoteEtudiant noteEtudiant)
        {
            ...
            {
                ModelState.AddModelError(nameof(NoteEtudiant.MatiereId), "Mati�re obligatoire.");
            }

            if (!noteEtudiant.UniteEnseignementId.HasValue)
            {
                ModelState.AddModelError(nameof(NoteEtudiant.UniteEnseignementId), "Unit� d'Enseignement obligatoire.");
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (parcours is null)
                {
                    ModelState.AddModelError(string.Empty, "Aucun parcours ne correspond � la combinaison s�lectionn�e (Mati�re + UE + Semestre).");
                }
                else
                {
